...
on messageSourceJson(msgRecord, accName, mbName, messageIndex)
	...
	return "{" & "\"id\":" & my jsonString(identityValue) & "," & "\"account\":" & my jsonString(accName) & "," & "\"mailbox\":" & my jsonString(mbName) & "," & "\"index\":" & (messageIndex as text) & "," & "\"subject\":" & my jsonString(subjectValue) & "," & "\"sender\":" & my jsonString(senderValue) & "," & "\"date_received\":" & dateReceivedValue & "," & "\"message_id\":" & my jsonNullable(messageIdValue) & "," & "\"source\":" & my jsonString(sourceValue) & "}"
